'''
How to use:
python serve_viz.py /data/fcr/code/event_vggt/Data_Part/StreamVGGT/src/output/evencoder_v2_lyt_perc/screen_1/point_cloud/merged.ply 8000
python serve_viz.py 'data_root' 'web_port'
'''
import os
import sys
import struct
